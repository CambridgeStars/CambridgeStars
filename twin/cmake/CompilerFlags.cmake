...
if (CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
   ...
   set (CMAKE_Fortran_FLAGS_RELEASE "${CMAKE_Fortran_FLAGS_RELEASE} ${OFLAGS} -pipe -funroll-all-loops")
   set (CMAKE_Fortran_FLAGS_DEBUG   "${CMAKE_Fortran_FLAGS_DEBUG} -g -ffpe-trap=zero,invalid -fsignaling-nans")
   set (CMAKE_Fortran_FLAGS_PROFILE "${CMAKE_Fortran_FLAGS_PROFILE} -g -gp")
...
elseif (CMAKE_Fortran_COMPILER_ID MATCHES "Intel")
   ...
   set (FPP_FLAGS "-fpp")
   set (CMAKE_Fortran_FLAGS         "${CMAKE_Fortran_FLAGS}  -nogen-interfaces")
   set (CMAKE_Fortran_FLAGS_RELEASE "${CMAKE_Fortran_FLAGS_RELEASE} ${OFLAGS} -vec-guard-write -fpconstant -extend_source -funroll-loops -align all -ip")
   set (CMAKE_Fortran_FLAGS_DEBUG   "${CMAKE_Fortran_FLAGS_DEBUG} -g -debug -traceback")
   set (CMAKE_Fortran_FLAGS_PROFILE "${CMAKE_Fortran_FLAGS_PROFILE} -g -gp")
...
elseif( CMAKE_Fortran_COMPILER_ID MATCHES "G95" )
  ...
  set( FPP_FLAGS "-cpp")
  set( CMAKE_Fortran_FLAGS_RELEASE "${CMAKE_Fortran_FLAGS_RELEASE} ${OFLAGS}")
